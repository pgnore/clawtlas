...
export default {
  ...
  "variants": {
    ...
    "color": {
      ...
      "indigo": {
        "trigger": "group-data-[state=completed]:bg-indigo group-data-[state=active]:bg-indigo focus-visible:outline-indigo",
        "separator": "group-data-[state=completed]:bg-indigo"
      },
      "emerald": {
        "trigger": "group-data-[state=completed]:bg-emerald group-data-[state=active]:bg-emerald focus-visible:outline-emerald",
      ...
      "purple": {
        "trigger": "group-data-[state=completed]:bg-purple group-data-[state=active]:bg-purple focus-visible:outline-purple",
