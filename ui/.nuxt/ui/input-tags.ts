...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-inset has-focus-visible:ring-indigo"
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-inset has-focus-visible:ring-emerald"
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-inset has-focus-visible:ring-amber"
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-inset has-focus-visible:ring-purple"
    },
    {
      "color": "primary" as typeof color[number],
      "highlight": true,
