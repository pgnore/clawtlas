...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "class": "focus:ring-2 focus:ring-inset focus:ring-indigo"
    },
    {
      ...
      "class": "focus:ring-2 focus:ring-inset focus:ring-emerald"
    },
    {
      ...
      "class": "focus:ring-2 focus:ring-inset focus:ring-amber"
    },
    {
      ...
      "class": "focus:ring-2 focus:ring-inset focus:ring-purple"
    },
    {
      "color": "primary" as typeof color[number],
      "highlight": true,
